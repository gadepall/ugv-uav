...
\begin{enumerate}
	\item Open Mission Planner \cite{missionplanner},
	    (you might have to use an older version for better compatibility) and flash the \texttt{ArduRover v2.5.1} firmware onto the APM 2.8 flight controller. Custom C++ code is not required for the APM, as the ArduPilot ecosystem provides precompiled stacks in the \href{https://ardupilot.org/}{ArduPilot website}.
    ...
    \begin{itemize}
        ...
        \item Outputs: Connect signal lines 1 and 3 of the radio receiver to the ESP32. 
    \end{itemize}
