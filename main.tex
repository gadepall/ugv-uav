...
To successfully transition from flight to ground, the components shown in Fig \ref{fig:da} must be re-routed. Below is the final, unified UGV architecture showing the new data and power workflows, utilizing the ArduPilot, an ESP32 translator, an LM2596 buck converter, and L298N drivers. 
